...
#ifndef QUBNET_WALLET_HDWALLET_H
#define QUBNET_WALLET_HDWALLET_H
...
public:
    ...
    // Staking Settings
    CAmount nStakeCombineThreshold = 1000 * COIN;
    CAmount nStakeSplitThreshold = 2000 * COIN;
    size_t nMaxStakeCombine = 3;
    int nWalletDevFundCedePercent = 0;
...
#endif // QUBNET_WALLET_HDWALLET_H
