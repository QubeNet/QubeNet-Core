...
static const uint8_t QUBNET_BLOCK_VERSION = 0xA0;
static const uint8_t QUBNET_TXN_VERSION = 0xA0;
static const uint8_t MAX_QUBNET_TXN_VERSION = 0xBF;
...
inline bool IsQubnetTxVersion(int nVersion)
{
    return (nVersion & 0xFF) >= QUBNET_TXN_VERSION;
}
...
inline void SerializeTransaction(const TxType& tx, Stream& s) {
    ...
    if (IsQubnetTxVersion(tx.nVersion))
    {
...
public:
    ...
    static const int32_t CURRENT_QUBNET_VERSION=0xA0;
    ...
    static const int32_t MAX_STANDARD_QUBNET_VERSION=0xA0;
...
public:
    ...
    bool IsQubnetVersion() const {
        return IsQubnetTxVersion(nVersion);
    }
    ...
    {
        return IsQubnetTxVersion(nVersion) ? vpout.size() : vout.size();
    }
