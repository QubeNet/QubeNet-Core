...
bool ProduceSignature(const BaseSignatureCreator& creator, const CScript& fromPubKey, SignatureData& sigdata)
{
    ...
    bool fIsP2SH = creator.IsQubnetVersion()
...
class DummySignatureCheckerQubnet : public BaseSignatureChecker
{
// IsQubnetVersion() must return true to skip stack evaluation
public:
    DummySignatureCheckerQubnet() {}

    bool IsQubnetVersion() const { return true; }
...
const DummySignatureCheckerQubnet dummyCheckerQubnet;
} // namespace
...
const BaseSignatureChecker& DummySignatureCreatorQubnet::Checker() const
{
    return dummyCheckerQubnet;
}
