...
public:
    ...
    virtual bool IsQubnetVersion() const { return false; }
...
public:
    ...
    bool IsQubnetVersion() const { return txTo && txTo->IsQubnetVersion(); }
...
public:
    bool IsQubnetVersion() const { return tx.IsQubnetVersion(); }
...
class DummySignatureCreatorQubnet : public DummySignatureCreator {
public:
    DummySignatureCreatorQubnet(const CKeyStore* keystoreIn) : DummySignatureCreator(keystoreIn) {}
