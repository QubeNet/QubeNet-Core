...
struct BasicTestingSetup {
    ...
    explicit BasicTestingSetup(const std::string& chainName = CBaseChainParams::MAIN, bool fQubnetModeIn = false);
    ~BasicTestingSetup();
};
...
struct TestingSetup: public BasicTestingSetup {
    ...
    explicit TestingSetup(const std::string& chainName = CBaseChainParams::MAIN, bool fQubnetModeIn = false);
    ~TestingSetup();
};
