...
extern bool fQubnetMode;


BasicTestingSetup::BasicTestingSetup(const std::string& chainName, bool fQubnetModeIn)
{
    fQubnetMode = fQubnetModeIn;
    ...
    ResetParams(chainName, fQubnetMode);
...
TestingSetup::TestingSetup(const std::string& chainName, bool fQubnetModeIn) : BasicTestingSetup(chainName, fQubnetModeIn)
{
    ...
    ClearDatadirCache();
    pathTemp = fs::temp_directory_path() / strprintf("test_qubnet_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
