...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-rpccorsdomain=<domain>", _("Allow JSON-RPC connections from specified domain (e.g. http://localhost:4200 or \"*\"). This needs to be set if you are using the Qubnet GUI in a browser."));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/qubnet/qubnet-core>";
    const std::string URL_WEBSITE = "<https://qubnet.io/>";
...
bool AppInitParameterInteraction()
{
    ...
    fQubnetMode = !gArgs.GetBoolArg("-legacymode", false); // qa tests
    if (gArgs.GetBoolArg("-regtest", false) && !fQubnetMode)
        ResetParams(CBaseChainParams::REGTEST, fQubnetMode);
...
bool AppInitMain()
{
    ...
    if (fQubnetMode) // SMSG breaks functional tests with services flag, see version msg
